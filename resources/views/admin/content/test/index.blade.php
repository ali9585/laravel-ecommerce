            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="card-header d-flex border-top rounded-0 flex-wrap py-md-0">
                    <div class="me-5 ms-n2 pe-5">
                        <div id="DataTables_Table_0_filter" class="dataTables_filter"><label><input type="search" class="form-control" placeholder="Search Product"
                    ...
                    <div class="d-flex justify-content-start justify-content-md-end align-items-baseline">
                        <div class="dt-action-buttons d-flex align-items-start align-items-md-center justify-content-sm-center mb-3 mb-sm-0">
                            <div class="dataTables_length mt-0 mt-md-3 me-3" id="DataTables_Table_0_length"><label><select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0"
                                        class="form-select">
                            ...
                            <div class="dt-buttons btn-group flex-wrap d-flex">
                                {{-- <div class="btn-group"><button class="btn buttons-collection dropdown-toggle btn-label-secondary me-3" data-bs-toggle="dropdown" tabindex="0" type="button"
                                        aria-haspopup="dialog" aria-expanded="false"><span><i class="bx bx-export me-1"></i>Export</span></button></div> --}}
                                <button class="btn buttons-collection dropdown-toggle btn-label-secondary me-3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span><i class="bx bx-export me-1"></i>Export</span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-end m-0 dt-button-collection" style="">
                                    <a class="dt-button dropdown-item buttons-print" tabindex="0" aria-controls="DataTables_Table_0" href="#"><span><i
                                                class="bx bx-printer me-2"></i>Print</span></a> <a class="dt-button dropdown-item buttons-csv buttons-html5" tabindex="0"
                                        aria-controls="DataTables_Table_0" href="#"><span><i class="bx bx-file me-2"></i>Csv</span></a> <a
                                        class="dt-button dropdown-item buttons-pdf buttons-html5" tabindex="0" aria-controls="DataTables_Table_0" href="#"><span><i
                                                class="bx bxs-file-pdf me-2"></i>Pdf</span></a> <a class="dt-button dropdown-item buttons-copy buttons-html5" tabindex="0"
                                        aria-controls="DataTables_Table_0" href="#"><span><i class="bx bx-copy me-2"></i>Copy</span></a>
                                </div>
                                <button class="btn btn-secondary add-new btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button"><span><i
                                            class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add Product</span></span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                            ...
                            <td class="sorting_1">
                                <div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-body text-nowrap mb-0">Air Jordan</h6><small class="text-muted text-truncate d-none d-sm-block">Air Jordan is a line of basketball shoes
                                            produced by Nike</small>
                                    </div>
                                </div>
                            </td>
                            <td><span class="text-truncate d-flex align-items-center"><span
                                        class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-info me-2"><i class="bx bx-walk"></i></span>Shoes</span></td>
                            <td><span class="text-truncate"><label class="switch switch-primary switch-sm"><input type="checkbox" class="switch-input" id="switch"><span
                                            class="switch-toggle-slider"><span class="switch-off"></span></span></label><span class="d-none">Out_of_Stock</span></span></td>
                            <td><span>31063</span></td>
                            <td class="" style=""><span>$125</span></td>
                            <td><span>942</span></td>
                        ...
                        <tr class="even">
                            ...
                            <td class="sorting_1">
                                <div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-body text-nowrap mb-0">Amazon Fire TV</h6><small class="text-muted text-truncate d-none d-sm-block">4K UHD smart TV, stream live TV
                                            without cable</small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="" style=""><span>$263.49</span></td>
                            <td><span>587</span></td>
                            <td class="" style=""><span class="badge bg-label-warning" text-capitalized="">Scheduled</span></td>
                            <td class="" style="">
                                <div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button><button
                                        class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded me-2"></i></button>
                                    <div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:0;" class="dropdown-item">View</a><a href="javascript:0;"
                        ...
                        <tr class="odd">
                            ...
                            <td><span class="text-truncate d-flex align-items-center"><span
                                        class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-primary me-2"><i
                                            class="bx bx-mobile-alt"></i></span>Electronics</span></td>
                            <td><span class="text-truncate"><label class="switch switch-primary switch-sm"><input type="checkbox" class="switch-input" checked=""><span
                                            class="switch-toggle-slider"><span class="switch-on"></span></span></label><span class="d-none">In_Stock</span></span></td>
                            <td><span>35946</span></td>
                            <td class="" style=""><span>$248.39</span></td>
                            <td><span>468</span></td>
                            <td class="" style=""><span class="badge bg-label-success" text-capitalized="">Publish</span></td>
                            <td class="" style="">
                                <div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button><button
                                        class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded me-2"></i></button>
                                    <div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:0;" class="dropdown-item">View</a><a href="javascript:0;"
                        ...
                        <tr class="even">
                            ...
                            <td class="sorting_1">
                                <div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-body text-nowrap mb-0">Apple Watch Series 7</h6><small class="text-muted text-truncate d-none d-sm-block">Starlight Aluminum Case with
                                            Starlight Sport Band.</small>
                                    </div>
                                </div>
                            </td>
                            <td><span class="text-truncate d-flex align-items-center"><span
                            ...
                            <td class="" style=""><span>$799</span></td>
                            <td><span>851</span></td>
                            <td class="" style=""><span class="badge bg-label-warning" text-capitalized="">Scheduled</span></td>
                            <td class="" style="">
                                <div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button><button
                        ...
                        <tr class="odd">
                            ...
                            <td class="sorting_1">
                                <div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-body text-nowrap mb-0">BANGE Anti Theft Backpack</h6><small class="text-muted text-truncate d-none d-sm-block">Smart Business Laptop
                                            Fits 15.6 Inch Notebook</small>
                                    </div>
                                </div>
                            </td>
                            <td><span class="text-truncate d-flex align-items-center"><span
                            ...
                            <td class="" style=""><span>$79.99</span></td>
                            <td><span>519</span></td>
                            <td class="" style=""><span class="badge bg-label-danger" text-capitalized="">Inactive</span></td>
                            <td class="" style="">
                                <div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button><button
                        ...
                        <tr class="even">
                            ...
                            <td class="sorting_1">
                                <div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-body text-nowrap mb-0">Canon EOS Rebel T7</h6><small class="text-muted text-truncate d-none d-sm-block">18-55mm Lens | Built-in Wi-Fi |
                                            24.1 MP CMOS Sensor</small>
                                    </div>
                                </div>
                            </td>
                            <td><span class="text-truncate d-flex align-items-center"><span
                            ...
                            <td class="" style=""><span>$399</span></td>
                            <td><span>810</span></td>
                            <td class="" style=""><span class="badge bg-label-warning" text-capitalized="">Scheduled</span></td>
                            <td class="" style="">
                                <div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button><button
                        ...
                        <tr class="odd">
                            ...
                            <td class="sorting_1">
                                <div class="d-flex justify-content-start align-items-center product-name">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-body text-nowrap mb-0">Dohioue Wall Clock</h6><small class="text-muted text-truncate d-none d-sm-block">Modern 10 Inch Battery Operated
                                            Wall Clocks</small>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="" style=""><span>$16.34</span></td>
                            <td><span>804</span></td>
                            <td class="" style=""><span class="badge bg-label-success" text-capitalized="">Publish</span></td>
                            <td class="" style="">
                                <div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></button><button
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            <ul class="pagination">
                                ...
                                <li class="paginate_button page-item "><a href="#" aria-controls="DataTables_Table_0" role="link" data-dt-idx="2" tabindex="0"
                                        class="page-link">3</a></li>
                                <li class="paginate_button page-item "><a href="#" aria-controls="DataTables_Table_0" role="link" data-dt-idx="3" tabindex="0"
                                        class="page-link">4</a></li>
                                <li class="paginate_button page-item "><a href="#" aria-controls="DataTables_Table_0" role="link" data-dt-idx="4" tabindex="0"
                                        class="page-link">5</a></li>
                                <li class="paginate_button page-item disabled" id="DataTables_Table_0_ellipsis"><a aria-controls="DataTables_Table_0" aria-disabled="true" role="link"
                                        data-dt-idx="ellipsis" tabindex="-1" class="page-link">…</a></li>
                                <li class="paginate_button page-item "><a href="#" aria-controls="DataTables_Table_0" role="link" data-dt-idx="14" tabindex="0"
